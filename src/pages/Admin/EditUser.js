    ...
    return (
      ...
      >
        <div className="bg-white  -mb-24" style={{ opacity: "1" }}>
          <div className="mx-5 ">
            <div className="bg-white  mt-28 justify-right absolute right-0 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" onClick={this.props.close}>
  ...
  <div className="contact__text mt-24">
    ...
    <div>
      ...
      <div class="bg-white rounded  p-4 px-4 md:p-8 mb-6 font-semibold">
        ...
        {this.state.roleEnter=="ADMIN"?( <img class=" w-full
         h-full"
              src={imageAdmin}/>) :
             ( 
