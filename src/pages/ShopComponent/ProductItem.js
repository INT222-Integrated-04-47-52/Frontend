  ...
  return (
    ...
    <div class="flex flex-col ">
            <div class="bg-white shadow-md  rounded-3xl p-4">
                ...
                alt={product.image} className=" w-full  object-scale-down lg:object-cover  lg:h-48 rounded-2xl"/>
                    </div>
                    <div class="flex-auto ml-3 justify-evenly py-2 text-left">
                        <div class="flex flex-wrap ">
                           
                            <h2 class="text-blue font-bold flex-auto text-xl font-semibold">    {product.name}</h2>
                        
                        </div>
                        <div className="flex text-left w-10/12"><h4 class="w-full flex-none text-sm font-medium text-gray-500 mt-2 ">
           ...
           <b>  
            </b></div>  <b className="mr-2"> Gender:  </b> {product.gender.genderName}
                            ...
                            <b className="mr-2"> Kind:  </b>     <p class=""> {product.kind.kindName}</p>
                            </div>
                             <div class="flex-1 inline-flex items-center ">
                            
                                   
                            
                             <b className="mr-2"> Type:  </b>   <p class=""> {product.type.typeName}</p>
                            </div>
                        </div>
              ...
              <div className="product__details__option__color">
                ...
                <p className="mr-2 font-black"> Color:  </p>    {product.productHasColors.map((c) => (
