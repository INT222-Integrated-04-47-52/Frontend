...
class EditProduct extends Component {
  ...
  save = async (e) => {
    ...
    const proId = await axios.get(
      `${process.env.REACT_APP_API_URL}/product/${this.state.productId}`
    );
    console.log(proId);
    ...
    if (this.state.productId) {
      ...
      if (this.state.file == null) {
        ...
        axios({
          url: `${process.env.REACT_APP_API_URL}/editProduct/image`,
          method: "PUT",
          data: formData,
        })
          .then((res) => {
      ...
      //    axios.put(`${process.env.REACT_APP_API_URL}/editProduct/image`, formData)
...
//       };
//     reader.readAsDataURL(file);
//     setFile({ file: inputFile ,imageName: file.imageName});
//   }

//     return (
//         <div style={{position : 'absolute', top:"0",left:'0' ,width: '100%',zIndex: '9999',height: '100%', backgroundColor : 'black', opacity: '0.4'}}>

//             <div style={{backgroundColor : 'white'}}>  <div onClick={props.close} style={{padding :'10px', color:'white' , background: 'red'}}>ปิด</div>
//             แก้ไขรายการสินค้า
...
//                 รูปภาพสินค้า:{" "}
//               </label>
//              <img class="my-5 w-48 md:w-96" alt="" src={ imageURL !== null ? imageURL : `${process.env.REACT_APP_API_URL}/image/${product.imageName}`}/>
//              <input
//                 type="file"
//                 class="w-1/2 md:w-80 mt-4 focus:outline-none"
//                 name="file"
